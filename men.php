<?php include 'header.php'; ?>
    ...
    <section class="max-w-7xl mx-auto px-6 py-16 pt-24">
        <div class="flex flex-col md:flex-row-reverse items-center gap-16">
            <div class="md:w-1/2">
                <p class="text-sm font-bold uppercase tracking-widest text-gray-500 mb-4">Bespoke Suiting</p>
                <h1 class="text-5xl md:text-6xl font-bold brand-font mb-6 leading-tight">Master tailoring for <span class="italic font-normal">men</span></h1>
                <p class="text-lg text-gray-800 mb-10 leading-relaxed">From sharp business suits to perfectly fitted casual wear, our master tailors bring Savile Row precision directly to your living room.</p>
                <a href="index.php#book" class="inline-block bg-brand-black text-brand-bg text-sm font-bold uppercase tracking-widest px-8 py-4 rounded-full shadow-lg hover:bg-gray-800 transition">Book Appointment</a>
            </div>
            <div class="md:w-1/2 w-full h-[600px]">
                <img src="https://images.unsplash.com/photo-1584184924103-e310d9dc82fc?q=80&w=2080&auto=format&fit=crop" alt="Men's Tailoring" class="w-full h-full object-cover rounded-sm shadow-xl">
            </div>
        </div>
    </section>

   <section class="py-24 bg-brand-bg border-y border-black/10 overflow-hidden">
        <div class="max-w-7xl mx-auto px-6 relative">
            
            <div class="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
                <h2 class="text-4xl md:text-5xl font-bold brand-font text-brand-black">Our Bespoke<br>Expertise For Men</h2>
                
                <div class="hidden md:flex space-x-4">
                    <button onclick="scrollSlider('left', 'slider-men')" class="w-12 h-12 rounded-full border border-brand-black flex items-center justify-center hover:bg-brand-black hover:text-brand-bg transition duration-300">
                    ...
                    <button onclick="scrollSlider('right', 'slider-men')" class="w-12 h-12 rounded-full border border-brand-black flex items-center justify-center hover:bg-brand-black hover:text-brand-bg transition duration-300">
            ...
            <div id="slider-men" class="flex overflow-x-auto snap-x snap-mandatory no-scrollbar gap-8 pb-4 scroll-smooth">
                
                <div class="group relative overflow-hidden bg-white cursor-pointer h-[500px] flex-none w-full md:w-[calc(33.333%-1.5rem)] snap-start">
                    <img src="https://images.unsplash.com/photo-1593032465175-481ac7f401a0?q=80&w=2080&auto=format&fit=crop" alt="Suit" class="w-full h-full object-cover transition duration-700 group-hover:scale-105">
                    <div class="absolute bottom-8 left-0 right-0 flex justify-center">
                        <div class="bg-brand-black text-brand-bg text-xs font-bold uppercase tracking-widest px-8 py-3 text-center">
                            Tailor-Made Suits
                        </div>
                    </div>
                </div>
                ...
                <div class="group relative overflow-hidden bg-white cursor-pointer h-[500px] flex-none w-full md:w-[calc(33.333%-1.5rem)] snap-start">
                    <img src="https://images.unsplash.com/photo-1603252109303-2751441dd157?q=80&w=1974&auto=format&fit=crop" alt="Resort Shirt" class="w-full h-full object-cover transition duration-700 group-hover:scale-105">
                    <div class="absolute bottom-8 left-0 right-0 flex justify-center">
                        <div class="bg-brand-black text-brand-bg text-xs font-bold uppercase tracking-widest px-8 py-3 text-center">
                            Bespoke Resort Shirts
                        </div>
                    </div>
                </div>

                <div class="group relative overflow-hidden bg-white cursor-pointer h-[500px] flex-none w-full md:w-[calc(33.333%-1.5rem)] snap-start">
                    <img src="https://images.unsplash.com/photo-1598808503746-f34c53b9323e?q=80&w=1974&auto=format&fit=crop" alt="Grandad Collar" class="w-full h-full object-cover transition duration-700 group-hover:scale-105">
                    <div class="absolute bottom-8 left-0 right-0 flex justify-center">
                        <div class="bg-brand-black text-brand-bg text-xs font-bold uppercase tracking-widest px-8 py-3 text-center">
                ...
                <div class="group relative overflow-hidden bg-white cursor-pointer h-[500px] flex-none w-full md:w-[calc(33.333%-1.5rem)] snap-start">
                    <img src="https://images.unsplash.com/photo-1507679799987-c73779587ccf?q=80&w=2071&auto=format&fit=crop" alt="Business Wear" class="w-full h-full object-cover transition duration-700 group-hover:scale-105">
                    <div class="absolute bottom-8 left-0 right-0 flex justify-center">
                        <div class="bg-brand-black text-brand-bg text-xs font-bold uppercase tracking-widest px-8 py-3 text-center">
                            Premium Trousers
                        </div>
    ...
    <script>
        function scrollSlider(direction, sliderId) {
            ...
            // Calculate width of one card + gap (approximate width to scroll by)
            const scrollAmount = slider.clientWidth / 1.5; 
        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="text-center max-w-3xl mx-auto mb-20">
                ...
                <p class="text-lg text-gray-700 leading-relaxed">
                    Home Stitch craftsmen present a perfect balance of style and finesse complementing your persona. Whether at home or online, our team of personal fashion designers take care of your requirements with precision.
                </p>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-3 gap-y-16">
                
                <div class="px-8 md:border-r border-black/10 text-center md:text-left flex flex-col items-center md:items-start">
                ...
                <div class="px-8 text-center md:text-left flex flex-col items-center md:items-start">
                    <div class="w-12 h-12 mb-6 text-brand-black">
                ...
                <div class="px-8 md:border-r border-black/10 text-center md:text-left flex flex-col items-center md:items-start">
                    ...
                    <p class="text-gray-600 leading-relaxed text-sm">Refurbish your much-loved outfits for a perfect fit with our experts.</p>
                </div>
                ...
                <div class="px-8 md:border-r border-black/10 text-center md:text-left flex flex-col items-center md:items-start">
                    ...
                    <p class="text-gray-600 leading-relaxed text-sm">Make your D-Day memorable with our exclusive pre-wedding to wedding couture.</p>
                </div>
                ...
                <div class="px-8 text-center md:text-left flex flex-col items-center md:items-start">
                    ...
                    <p class="text-gray-600 leading-relaxed text-sm">Renew and recreate magic with your old outfits and transform them to a completely new attire.</p>
                </div>

            </div>

            <div class="text-center mt-20">
                <a href="index.php#book" class="inline-block bg-brand-black text-brand-bg text-sm font-bold uppercase tracking-widest px-10 py-4 rounded-full shadow-lg hover:bg-gray-800 transition transform hover:-translate-y-1">
                    Book an Appointment
                </a>
            </div>
