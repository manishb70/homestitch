<?php include 'header.php'; ?>
    ...
    <section class="max-w-7xl mx-auto px-6 py-16 pt-24">
        <div class="flex flex-col md:flex-row items-center gap-16">
            <div class="md:w-1/2">
                <p class="text-sm font-bold uppercase tracking-widest text-gray-500 mb-4">Comfort & Style</p>
                <h1 class="text-5xl md:text-6xl font-bold brand-font mb-6 leading-tight">Custom fits for <span class="italic font-normal">kids</span></h1>
                <p class="text-lg text-gray-800 mb-10 leading-relaxed">Growing kids need comfortable, durable, and stylish clothing. We craft custom ethnic wear, party dresses, and casuals tailored specifically for them.</p>
                ...
                <div class="flex gap-4">
                    ...
                    <a href="#contact" class="inline-block border-2 border-brand-black text-brand-black text-sm font-bold uppercase tracking-widest px-8 py-4 rounded-full hover:bg-brand-black hover:text-brand-bg transition">Contact Us</a>
                </div>
            </div>
            <div class="md:w-1/2 w-full h-[600px] relative">
                <img src="https://images.unsplash.com/photo-1518831959646-742c3a14ebf7?q=80&w=2008&auto=format&fit=crop" alt="Kids Custom Tailoring" class="w-full h-full object-cover rounded-sm shadow-xl">
            </div>
        </div>
    </section>

    <section class="py-24 bg-brand-bg border-t border-black/10">
        <div class="max-w-7xl mx-auto px-6">
            
            <div class="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
                <h2 class="text-4xl md:text-5xl font-bold brand-font text-brand-black">Our Bespoke<br>Expertise For Kids</h2>
                
                <div class="hidden md:flex space-x-4">
                    <button class="w-12 h-12 rounded-full border border-brand-black flex items-center justify-center hover:bg-brand-black hover:text-brand-bg transition duration-300">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="group relative overflow-hidden bg-white cursor-pointer h-[500px]">
                    <img src="https://images.unsplash.com/photo-1622290319146-7b63df48a635?q=80&w=1972&auto=format&fit=crop" alt="Kids Party Wear" class="w-full h-full object-cover transition duration-700 group-hover:scale-105">
                    <div class="absolute bottom-6 left-0 right-0 flex justify-center px-4">
                        <div class="bg-brand-black/90 backdrop-blur-sm text-brand-bg text-sm font-semibold uppercase tracking-widest px-6 py-3 w-full max-w-[80%] text-center">
                            Custom Party Wear
                        </div>
                    </div>
                </div>
                ...
                <div class="group relative overflow-hidden bg-white cursor-pointer h-[500px]">
                    <img src="https://images.unsplash.com/photo-1503919545889-aef636e10ad4?q=80&w=1974&auto=format&fit=crop" alt="Kids Casuals" class="w-full h-full object-cover transition duration-700 group-hover:scale-105">
                    <div class="absolute bottom-6 left-0 right-0 flex justify-center px-4">
                        <div class="bg-brand-black/90 backdrop-blur-sm text-brand-bg text-sm font-semibold uppercase tracking-widest px-6 py-3 w-full max-w-[80%] text-center">
                            Comfortable Casuals
                        </div>
                ...
                <div class="group relative overflow-hidden bg-white cursor-pointer h-[500px]">
                    <img src="https://images.unsplash.com/photo-1519689680058-324335c77eba?q=80&w=2074&auto=format&fit=crop" alt="Kids Formal" class="w-full h-full object-cover transition duration-700 group-hover:scale-105">
                    <div class="absolute bottom-6 left-0 right-0 flex justify-center px-4">
                        <div class="bg-brand-black/90 backdrop-blur-sm text-brand-bg text-sm font-semibold uppercase tracking-widest px-6 py-3 w-full max-w-[80%] text-center">
                            Miniature Bespoke
                        </div>
    ...
    <section class="py-24 bg-brand-bg border-t border-black/10">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-y-16 gap-x-8">
                <div class="md:border-r border-black/10 text-center flex flex-col items-center px-4">
                ...
                <div class="md:border-r border-black/10 text-center flex flex-col items-center mt-8 px-4">
                    <div class="w-12 h-12 mb-6 text-brand-black">
                ...
                <div class="md:border-r border-black/10 text-center flex flex-col items-center mt-8 px-4">
                    ...
                    <h3 class="text-2xl brand-font font-bold mb-3">Special Occasions</h3>
                    <p class="text-gray-600 leading-relaxed text-sm">Make your little one's presence memorable with our exclusive event couture.</p>
                </div>

                <div class="text-center flex flex-col items-center mt-8 px-4">
                    <div class="w-12 h-12 mb-6 text-brand-black">
                    ...
                    <p class="text-gray-600 leading-relaxed text-sm">Renew and recreate magic with their old outfits and transform them to completely new attire.</p>
                </div>
            </div>
